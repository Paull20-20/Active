...
class Customers(models.Model):
    ...
    email = models.EmailField(db_column='Email', max_length=180, unique=True, error_messages={'unique': "O email cadastrado já existe, por favor, cadastre outro!"} )
    year = models.IntegerField(db_column='Year', max_length=4, blank=True, null=True ) #criado para questão 6
    ...
    phone = models.CharField(db_column='Phone', blank=True, null=True, max_length=24, unique=True, error_messages={'unique': "O telefone cadastrado já existe, por favor, cadastre outro!"})
